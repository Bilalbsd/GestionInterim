...
class AcceptedOffersFragment : Fragment(), CandidaturesAdapter.OnCandidatureClickListener {
    ...
    private fun displayAcceptedCandidatures() {
        ...
        databaseReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                adapter = CandidaturesAdapter(requireContext(), acceptedCandidaturesList, this@AcceptedOffersFragment)
    ...
    override fun onCandidatureClick(candidature: CandidatureModel) {
        ...
        val acceptedOfferDetailFragment = AcceptedOffersDetailFragment.newInstance(candidature)
        parentFragmentManager.beginTransaction()
            .replace(R.id.fragment_container, acceptedOfferDetailFragment)
            .addToBackStack(null)
            .commit()
    }
