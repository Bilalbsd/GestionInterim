...
import PendingOffersEmployerFragment
...
import com.example.gestioninterim.userInscrit.AcceptedOffersEmployerFragment
...
class ProfileEmployerFragment : Fragment() {
    ...
    private fun navigateToPendingCandidaturesFragment() {
        val fragment = PendingOffersEmployerFragment()
    ...
    private fun navigateToAcceptedCandidaturesFragment() {
        val fragment = AcceptedOffersEmployerFragment()
        parentFragmentManager.beginTransaction()
            .replace(R.id.fragment_container, fragment)
            .addToBackStack(null)
            .commit()
